...
var Box = function (_Shape) {
  ...
  (0, _createClass3.default)(Box, [{
    ...
    value: function build() {
      ...
      var Mesh = this.physics ? _whitestormjsPhysijs2.default.BoxMesh : _three2.default.Mesh;
      ...
      return new _promise2.default(function (resolve) {
        _this2.setNative(new Mesh(new _three2.default.BoxGeometry(params.geometry.width, params.geometry.height, params.geometry.depth), material, params.mass));
