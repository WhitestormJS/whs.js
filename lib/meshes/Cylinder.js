...
var Cylinder = function (_Shape) {
  ...
  (0, _createClass3.default)(Cylinder, [{
    ...
    value: function build() {
      ...
      var _scope = this,
          Mesh = this.physics ? _whitestormjsPhysijs2.default.CylinderMesh : _three2.default.Mesh,
      ...
      return new _promise2.default(function (resolve) {
        _scope.setNative(new Mesh(new _three2.default.CylinderGeometry(params.geometry.radiusTop, params.geometry.radiusBottom, params.geometry.height, params.geometry.radiusSegments), material, params.mass));
