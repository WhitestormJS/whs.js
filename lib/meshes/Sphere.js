...
var Sphere = function (_Shape) {
  ...
  (0, _createClass3.default)(Sphere, [{
    ...
    value: function build() {
      ...
      var _scope = this,
          Mesh = this.physics ? _whitestormjsPhysijs2.default.SphereMesh : _three2.default.Mesh,
      ...
      return new _promise2.default(function (resolve) {
        _scope.setNative(new Mesh(new _three2.default.SphereGeometry(params.geometry.radius, params.geometry.segmentA, params.geometry.segmentB), material, params.mass));
