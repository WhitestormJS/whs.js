  ...
  (0, _createClass3.default)(Parametric, [{
    ...
    value: function build() {
      ...
      return new _promise2.default(function (resolve) {
        _scope.setNative(new Mesh(new _three2.default.ParametricGeometry(params.geometry.func, params.geometry.slices, params.geometry.stacks), material, params.mass));
