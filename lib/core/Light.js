  ...
  (0, _createClass3.default)(Light, [{
    ...
    value: function follow(curve) {
      ...
      var animation = new _Loop2.default(function (clock) {
        ...
        if (!lookAt) _scope.lookAt(vec2);else if (lookAt instanceof _three2.default.Vector3) _scope.lookAt(lookAt);else if (lookAt instanceof _three2.default.Curve || lookAt instanceof _three2.default.CurvePath) _scope.lookAt(lookAt.getPoint(u));
      });
