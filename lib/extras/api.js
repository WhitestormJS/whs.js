...
var loadMaterial = function loadMaterial() {
  ...
  var _restitution = !isNaN(parseFloat(material.restitution)) ? material.restitution : !isNaN(parseFloat(material.rest)) ? material.rest : 0.3;

  var _friction = !isNaN(parseFloat(material.friction)) ? material.friction : !isNaN(parseFloat(material.fri)) ? material.fri : 0.8;

  var materialThree = void 0,
      materialPhysi = void 0;
  ...
  if (!!'physics') {
    materialPhysi = Physijs.createMaterial(materialThree, _friction, _restitution);
  }
