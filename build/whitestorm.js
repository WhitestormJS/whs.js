(function (exports,THREE$1) {
	...
	function FPSControls(object, params = {}) {
	  ...
	  const controls = new ((camera, mesh, params) => {
	    ...
	    const scope = this,
	      player = mesh,
	      pitchObject = new THREE$1.Object3D();

	    pitchObject.add(camera.getNative());

	    const yawObject = new THREE$1.Object3D();

	    yawObject.position.y = params.ypos; // eyes are 2 meters above the ground
	    yawObject.add(pitchObject);

	    const quat = new THREE$1.Quaternion();
	    ...
	    const inputVelocity = new THREE$1.Vector3(),
	      euler = new THREE$1.Euler();

	    this.update = (delta) => {
	      const moveVec = new THREE$1.Vector3();
	...
	var ThreeOrbitControls = (index && typeof index === 'object' && 'default' in index ? index['default'] : index);
