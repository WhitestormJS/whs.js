...
const pointer = new (PHYSICS.$rigidBody(WHS.Sphere, PHYSICS.SPHERE))({material: {color: UTILS.$colors.mesh, kind: 'phong'}});
...
const constraint = new PHYSICS.DOFConstraint(box2.native, box.native,
